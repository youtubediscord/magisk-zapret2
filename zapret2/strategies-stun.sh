...
list_stun_strategies() {
    echo "disabled fake_veryfast_stun_discord fake_x6_stun_discord fake_x6_stun_discord fake_x6_30_out_stun_discord fake_x6_30_out_stun_discord fake_x6_2plus_stun_discord fake_x6_2plus_stun_discord fake_x3_stun_discord fake_x3_stun_discord fake_x6_pad_stun_discord fake_x6_pad_stun_discord fake_x6_10_out_stun_discord fake_x6_10_out_stun_discord fake_x6_20_out_stun_discord fake_x6_20_out_stun_discord fake_x3_2plus_stun_discord fake_x3_2plus_stun_discord fake_x3_30_out_stun_discord fake_x3_30_out_stun_discord fake_x3_pad_stun_discord fake_x3_pad_stun_discord fake_x6_50_out_stun_discord fake_x6_50_out_stun_discord fake_x3_10_out_stun_discord fake_x3_10_out_stun_discord fake_x3_20_out_stun_discord fake_x3_20_out_stun_discord fake_x10_stun_discord fake_x10_stun_discord fake_x3_50_out_stun_discord fake_x3_50_out_stun_discord fake_x6_100_out_stun_discord fake_x6_100_out_stun_discord fake_x3_100_out_stun_discord fake_x3_100_out_stun_discord fake_x10_30_out_stun_discord fake_x10_30_out_stun_discord fake_x10_2plus_stun_discord fake_x10_2plus_stun_discord fake_x10_pad_stun_discord fake_x10_pad_stun_discord fake_x10_10_out_stun_discord fake_x10_10_out_stun_discord fake_x10_20_out_stun_discord fake_x10_20_out_stun_discord fake_x10_50_out_stun_discord fake_x10_50_out_stun_discord fake_x10_100_out_stun_discord fake_x10_100_out_stun_discord"
}
...
get_stun_strategy_options() {
    ...
    case "$strategy_name" in
        ...
        fake_x6_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=-d10 --lua-desync=fake:blob=stun:repeats=6"
            ;;
        ...
        fake_x3_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=-d10 --lua-desync=fake:blob=stun:repeats=3"
            ;;

        fake_x6_pad_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=-d10 --lua-desync=fake:blob=stun:repeats=6+udplen:delta=2"
            ;;
        ...
        fake_x6_20_out_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=-d20 --lua-desync=fake:blob=stun:repeats=6"
            ;;

        fake_x3_2plus_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=2+ --lua-desync=fake:blob=stun:repeats=3"
            ;;
        ...
        fake_x6_50_out_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=-d50 --lua-desync=fake:blob=stun:repeats=6"
            ;;
        ...
        fake_x3_20_out_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=-d20 --lua-desync=fake:blob=stun:repeats=3"
            ;;
        ...
        fake_x10_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=-d10 --lua-desync=fake:blob=stun:repeats=10"
            ;;
        ...
        fake_x3_50_out_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=-d50 --lua-desync=fake:blob=stun:repeats=3"
            ;;
        ...
        fake_x6_100_out_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=-d100 --lua-desync=fake:blob=stun:repeats=6"
            ;;
        ...
        fake_x3_100_out_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=-d100 --lua-desync=fake:blob=stun:repeats=3"
            ;;
        ...
        fake_x10_30_out_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=-d30 --lua-desync=fake:blob=stun:repeats=10"
            ;;
        ...
        fake_x10_2plus_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=2+ --lua-desync=fake:blob=stun:repeats=10"
            ;;
        ...
        fake_x10_pad_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=-d10 --lua-desync=fake:blob=stun:repeats=10+udplen:delta=2"
            ;;
        ...
        fake_x10_20_out_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=-d20 --lua-desync=fake:blob=stun:repeats=10"
            ;;
        ...
        fake_x10_50_out_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=-d50 --lua-desync=fake:blob=stun:repeats=10"
            ;;
        ...
        fake_x10_100_out_stun_discord)
            echo "$filter --payload=stun,discord_ip_discovery --out-range=-d100 --lua-desync=fake:blob=stun:repeats=10"
            ;;
